    ...
    <>
      <div className="container-fluid " style={{ height: "100%" }}>
        ...
        <nav className="navbar d-lg-none navbar-sticky navbar-expand-lg navbar-light bg-white ps-2 pe-2 shadow">
          <a
            className="d-none d-lg-block navbar-brand text-primary fs-3 fw-bold"
            href="/"
          >
            Lateform
          </a>
          ...
          <div
            className="d-inline-flex d-inline text-center  justify-content-around"
            style={{ width: "100%" }}
          >
            <a
              className="navbar-brand d-lg-none text-primary fs-3 fw-bold"
              href="/"
            >
              Lateform
            </a>
            ...
            >
              <span
                ...
                aria-expanded="false"
                data-target="#attendeeNav"
                className=" d-lg-none  nav-item  rounded-circle border ms-1  bg-light text-dark p-1"
                style={{ width: "40px", height: "40px" }}
              >
                <Search size={30} className="p-1" />{" "}
              </span>
              <span
                className="nav-item  rounded-circle border ms-1  bg-light text-dark p-1"
                style={{ width: "40px", height: "40px" }}
                onClick={() => {
                  setVal(8);
                }}
              >
                <ChatDotsFill size={30} className="p-1" />{" "}
              </span>
              <span
                className="nav-item  rounded-circle border  ms-1 bg-light text-dark p-1"
                style={{ width: "40px", height: "40px" }}
              ...
              >
                <GearFill size={30} className="p-1" />{" "}
              </span>
            </div>
          </div>
          ...
          <div className="row">
            <div className="d-none d-lg-block fixed-nav border-right">
              <ul className="navbar-nav">
                <li>
                  <a
                    className="navbar-brand text-primary fs-3 fw-bold "
                    href="/"
                  >
                    Lateform
                  </a>
                ...
                <li
                  className="mt-5 fs-5 fw-light cursor-pointer"
                  onClick={() => {
                    setVal(2);
                  }}
                >
                  <HouseFill className="mb-1 me-1 " /> Home
                </li>
                <li
                  className="mt-4 fs-5 fw-light cursor-pointer"
                  onClick={() => {
                    setVal(7);
                  }}
                >
                  <PersonCircle className="mb-1 me-1 " /> Profile
                </li>
                <li
                  className="mt-4 fs-5 fw-light cursor-pointer"
                  onClick={() => {
                ...
                >
                  <ChatDotsFill className="mb-1 me-1 " /> Chats
                </li>
                <li
                  className="mt-4 fs-5 fw-light cursor-pointer"
                  onClick={() => {
                ...
                >
                  <TicketFill className="mb-1 me-1 " /> tickets & events
                </li>
                ...
                >
                  <GearFill className="mb-1 me-1 " /> Settings
                </li>
              </ul>
            </div>
            <div className="content-disp">{returnElement()}</div>
          </div>
        </div>
        ...
        <div className="d-lg-none shadow bottom-nav">
          <div className=" mt-2 d-lg-none bottom-nav-flex ">
            <span
              className="d-block  pt-2  fs-6 "
              onClick={() => {
                setVal(2);
              }}
            >
              <HouseFill size={25} className=" mb-2 text-primary" />
            </span>
            <span
              className="d-block pt-2   fs-6"
              onClick={() => {
            ...
            >
              <PersonCircle size={25} className=" mb-2 text-primary" />
            </span>
            ...
            >
              <TicketPerforatedFill size={25} className=" mb-2 text-primary" />
            </span>
          </div>
        </div>
      </div>
