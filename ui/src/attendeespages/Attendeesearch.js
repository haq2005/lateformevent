  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        axios
          .post(
            process.env.REACT_APP_BACKEND_URL + "/community/getCommunities",
      ...
      <div>
        <div className="d-flex justify-content-center mt-3">
          <div className="col-12">
            <b>Community</b>
            {comFetch === true ? (
              <div className="d-flex community-disp" style={{ width: "100%" }}>
                  ...
                  return (
                    <div className="p-2 col-lg-2 col-4 p-1 text-center">
                      ...
                      <span className="mt-1 text-nowrap ">
                        {val.communityName.slice(0, 7)}...
                      </span>
                      <span
                        className="d-block text-primary text-center cursor-pointer"
                        data-toggle="modal"
                        data-target="#joinGroupModal"
                        onClick={() => {
                          setJoin((prev) => {
                            return {
                              ...prev,
                ...
                <div className="mt-2 text-center">
                  <div className="text-center">
                    <p className="text-secondary fs-5">
                      Sorry,There is no events are hosted!
                    </p>
                  ...
                  {events.map((val) => {
                    ...
                    if (d1 > d2) {
                      return (
                        <>
                          <div
                            className="mb-5 event-thumbnail"
                            type="button"
                            onClick={() => {
                              navigate("/event-invitation?id=" + val._id);
                            }}
                          >
